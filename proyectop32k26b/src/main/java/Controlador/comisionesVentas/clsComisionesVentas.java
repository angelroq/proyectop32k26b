 ...
 * @author giron
 */
public class clsComisionesVentas {
    ...
    public clsComisionesVentas (){
        
    }
    public clsComisionesVentas(int id_comision, int ven_id, int id_empleado, double monto_ventas, double meta, double ventas_adicionales, double comision) {
    ...
    public String toString() {
        return "clsComisionesVentas{" + "id_comision=" + id_comision + ", ven_id=" + ven_id + ", id_empleado=" + id_empleado + ", monto_ventas=" + monto_ventas + ", meta=" + meta + ", ventas_adicionales=" + ventas_adicionales + ", comision=" + comision + '}';
    }
}
